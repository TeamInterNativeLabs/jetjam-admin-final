...
import { useAddAlbumMutation } from "../../Redux/Apis/Albums"
...
const AddAlbum = () => {
    ...
    const { control, handleSubmit, watch, setValue, formState: { errors } } = useForm({ defaultValues: { suggested: false, new: false, trending: false, tracks: [{ name: "" }] } })
    ...
    return (
        <DashboardLayout>
            <div className="dashCard mb-4">
                ...
                <div className="row mb-3">
                    <div className="col-8">
                        ...
                        <div className="d-flex flex-column">
                            {
                                file &&
                                <audio src={URL.createObjectURL(file)} controls className="my-3" />
                            }
                            <div>
                ...
                <div className="row mb-3">
                    <div className="col-4">
                        <h4 className="mainTitle">Select Image <span className="text-danger">*</span></h4>
