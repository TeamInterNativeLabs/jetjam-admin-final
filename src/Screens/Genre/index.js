...
import { useGetGenreQuery, useUpdateGenreMutation } from "../../Redux/Apis/Genre";
...
const Genre = () => {
  ...
  const [changeUserStatus, { isLoading: isUpdating }] = useUpdateGenreMutation();
    ...
    <>
      <DashboardLayout>
        <div className="container-fluid">
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Genre</h2>
                  </div>
                  <div className="col-md-6 mb-2">
          ...
          <CustomModal loading={isUpdating} show={showModal} close={() => { setShowModal(false) }} action={inactiveMale} heading='Are you sure you want to mark this genre as inactive?' />
          <CustomModal show={showModal2} close={() => { setShowModal2(false) }} success heading='Marked as Inactive' />

          <CustomModal loading={isUpdating} show={showModal3} close={() => { setShowModal3(false) }} action={activeMale} heading='Are you sure you want to mark this genre as Active?' />
