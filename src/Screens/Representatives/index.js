...
export const Representatives = () => {
  ...
  useEffect(() => {
    document.title = 'JetJams | Representative Management';
  }, []);
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Representatives</h2>
                  </div>
                  <div className="col-md-6 mb-2">
                                ...
                                <td>
                                  <Dropdown className="tableDropdown">
                                    ...
                                    <Dropdown.Menu align="end" className="tableDropdownMenu">
                                      <Link to={`/representatives/${item._id}`} className="tableAction"><FontAwesomeIcon icon={faEye} className="tableActionIcon" />View</Link>
                                      <button onClick={() => {
