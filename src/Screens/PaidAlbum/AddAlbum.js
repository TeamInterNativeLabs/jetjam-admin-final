        ...
        <div className="row mb-3">
          <div className="col-8">
            <h4 className="mainTitle">
              Upload zip <span className="text-danger">*</span>
            </h4>
            ...
            <div className="d-flex flex-column">
              {file && (
                <div className="mb-3 zip-preview">
                  <button
            ...
            <input
              type="file"
              hidden
              ref={audio_ref} // 👈 update this if you're using a separate ref for zip
              ...
              <Controller
                ...
                render={({ field }) => (
                  <input
                    ...
                    className="mx-2"
                    checked={suggested}
                    onChange={() => setValue("suggested", !suggested)}
                  />
                )}
              />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <input
                    ...
                    className="mx-2"
                    checked={newAlbum}
                    onChange={() => setValue("new", !newAlbum)}
                  />
                )}
              />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <input
                    ...
                    className="mx-2"
                    checked={trending}
                    onChange={() => setValue("trending", !trending)}
                  />
                )}
              />
          ...
          <div key={item.id} className="row my-3 d-flex align-items-center">
            ...
            {fields.length > 1 && (
              <div className="col-4 d-flex align-items-center">
                <label
                  className="mainLabel text-danger text-end text-underline"
